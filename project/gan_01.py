...
def reduce_mem_usage(df, verbose=True):
    ...
    return df
train_transaction = pd.read_csv('./ieee/train_transaction.csv', index_col='TransactionID')
test_transaction = pd.read_csv('./ieee/test_transaction.csv', index_col='TransactionID')
train_identity = pd.read_csv('./ieee/train_identity.csv', index_col='TransactionID')
test_identity = pd.read_csv('./ieee/test_identity.csv', index_col='TransactionID')
sample_submission = pd.read_csv('./ieee/sample_submission.csv', index_col='TransactionID')
...
xgb_submission.to_csv('IEEE_xgboost.csv')
